...
az group create --name $rgname --location $region && az vm create -n $vmname -g $rgname --image UbuntuLTS --admin-username azureadmin --generate-ssh-keys --custom-data bs-init.txt
